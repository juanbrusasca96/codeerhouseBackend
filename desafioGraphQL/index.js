...
if (process.argv.includes("cluster") && cluster.isMaster) {
	...
	const srv = app.listen(argv.port, async () => {
		...
		const mongo = new MongoDB('mongodb+srv://juanbrusasca:iacc40105795@cluster0.f6mjx6z.mongodb.net/ecommerce?retryWrites=true&w=majority');
		await mongo.conectar('mongodb+srv://juanbrusasca:iacc40105795@cluster0.f6mjx6z.mongodb.net/ecommerce?retryWrites=true&w=majority');
	});
}
